...
public class FrameworkTest extends TestCase {
    ...
    public void testParsing () throws Exception {
        String tags[] = {"table"};
        Parse p = new Parse("leader<Table foo=2>body</table>trailer", tags);
    ...
    public void testTypeAdapter () throws Exception {
        ...
        Class params[] = {};
        a = TypeAdapter.on(f, f.getClass().getMethod("pi", params));
        ...
        int b[] = {1,2,3};
        assertTrue(a.equals(b, f.sampleArray));
    ...
    public void testScientificDouble() {
        ...
        assertEquals(ScientificDouble.valueOf("3.141"), pi);
        assertEquals(ScientificDouble.valueOf("3.1415"), pi);
        ...
        assertEquals(ScientificDouble.valueOf("6.0e23"), av);
    }
