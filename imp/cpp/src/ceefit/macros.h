...
# define begin_fit_fixture(fixtureName, extendsType, alias)                                                         \
    ...
    {                                                                                                               \
      private:                                                                                                      \
        ...
        {                                                                                                           \
          public:                                                                                                   \
            ...
            {                                                                                                       \
              RUNNER::IncInFixtureConstructor();                                                                    \
            }                                                                                                       \
        };                                                                                                          \
      ...
      public:                                                                                                       \
        ...
        {                                                                                                           \
          public:                                                                                                   \
            static inline fixtureName* GetFixtureSubclass(FIXTURE* aFixture)                                        \
            {                                                                                                       \
              extendsType* extendsFixture = dynamic_cast< extendsType* >(aFixture);                                 \
              if(extendsFixture == NULL)                                                                            \
              {                                                                                                     \
                throw new EXCEPTION(STRING("GetFixtureSubclass failed to cast FIXTURE to ") + #extendsType +        \
              ...
              {                                                                                                     \
                throw new EXCEPTION(STRING("GetFixtureSubclass failed to cast ") + #extendsType + " to " +          \
      ...
      private:                                                                                                      \
        ...
        {                                                                                                           \
          public:                                                                                                   \
            ...
            {                                                                                                       \
              RUNNER::DecInFixtureConstructor();                                                                    \
            }                                                                                                       \
        };                                                                                                          \
        FIXTUREENDBODY fixtureName##_EndBody;                                                                       \
    };                                                                                                              \
    static REGISTERFIXTURECLASS< fixtureName > fixtureName##_CeeFITFixtureRegistration(#fixtureName, fixtureName::PROVIDEFIXTUREALIAS::GetFixtureAlias());
        ...
        public:                                                                                                     \
          ...
          {                                                                                                         \
            return #varName;                                                                                        \
                                                                                                                    ...
                                                                                                                    \
          static inline varType& ceefit_call_spec GetField(FIXTURE* aFixture)                                       \
          {                                                                                                         \
            return(PROVIDEFIXTUREOBJECTCASTER::GetFixtureSubclass(aFixture)->varName);                              \
          }                                                                                                         \
      };                                                                                                            \
      friend class SETFIELDINFO<PROVIDEFIELDINFO_##varName>;                                                        \
                                                                                                                    \
    public:                                                                                                         \
      SETFIELDINFO<PROVIDEFIELDINFO_##varName> varName##_SetFitFieldName
...
# define fit_test(testName, returnType)                                                                             \
    ...
    private:                                                                                                        \
      ...
      {                                                                                                             \
        public:                                                                                                     \
          static inline returnType CallFitTest(FIXTURE* fixture,                                                    \
      ...
      friend class SETTESTNAME<PROVIDETESTNAME_##testName>;                                                         \
                                                                                                                    \
      SETTESTNAME<PROVIDETESTNAME_##testName> testName##_SetCeeFITTestName;                                         \
                                                                                                                    \
    public:                                                                                                         \
